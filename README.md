...
This repository builds the [GeoEpi Lab Book](https://jmhumphreys.github.io/geoepi-notebook/), a practical guide for GeoEpi scientists and collaborators.
...
The current site is published at [jmhumphreys.github.io/geoepi-notebook](https://jmhumphreys.github.io/geoepi-notebook/). Historical lifecycle-oriented pages and superseded templates remain under [`archive/`](archive/README.md) for future reuse and are excluded from active navigation and rendering.
