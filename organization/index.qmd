...
| Term | Meaning |
|---|---|
| **GeoEpi Hub** | The future single lab-level project-management and portfolio repository in the [GeoEpi GitHub organization](https://github.com/geoepi). It holds project context and coordination. |
...
Read the [GeoEpi Hub architecture](project-hub.qmd), [project and subproject guidance](projects-and-subprojects.qmd), and [repository guidance](repositories.qmd) for practical decisions.
